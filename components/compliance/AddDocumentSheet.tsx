  ...
  return (
    <BottomSheet open={open} onClose={onClose}>
      ...
      <div className="mt-5 grid grid-cols-2 gap-3">
        <CaptureTile icon="file-text" label="Scan Document" onClick={capture} />
        <CaptureTile icon="camera" label="Take Photo" onClick={capture} />
      </div>

      <div className="mt-3 space-y-2">
        <CaptureRow icon="folder" label="Upload from Files" onClick={capture} />
        <CaptureRow
          icon="image"
